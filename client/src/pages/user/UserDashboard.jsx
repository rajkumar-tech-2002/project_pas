...
const UserDashboard = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setAppointments(
        all.filter((app) => app.user_id === currentUser.username),
      );
    };
    loadData();
  }, []);
      ...
      <div className="row align-items-center mb-4">
        <div className="col-lg-8">
          ...
          <p className="text-muted fs-6 mb-0">
            Welcome back, {currentUser.username} &bull; Academic Year 2025-26
          </p>
        </div>
        <div className="col-lg-4 text-lg-end mt-4 mt-lg-0">
          <Link
            to="/user/book"
            className="btn btn-primary-navy col-12 col-lg-auto py-3"
          >
            ...
            <div className="card-body p-4 text-white">
              <div className="d-flex justify-content-between align-items-start mb-4">
                ...
                <div className="text-end">
                  ...
                  <p className="small opacity-75 mb-0 text-uppercase tracking-widest">
                    Active
                  </p>
                </div>
              </div>
              ...
              <p className="small opacity-75 mt-2 mb-0">
                Your upcoming sessions with the Principal.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-start mb-4">
                ...
                <div className="text-end">
                  ...
                  <p className="small text-muted mb-0 text-uppercase tracking-widest">
                    History
                  </p>
                </div>
              </div>
              ...
              <p className="small text-muted mt-2 mb-0">
                Archive of your previous appointments.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card h-100 border-0 shadow-sm bg-light">
            <div className="card-body p-4 d-flex flex-column align-items-center justify-content-center text-center">
              ...
              <p className="small text-muted mb-3">
                Ensure your contact details are up to date for notifications.
              </p>
      ...
      <div className="card border-0 shadow-sm">
        <div className="card-header bg-white border-0 p-4 pb-0 d-flex justify-content-between align-items-center">
          ...
          <Link
            ...
            className="text-decoration-none small d-flex align-items-center fw-bold text-primary-navy"
          >
        ...
        <div className="card-body p-4">
          {activeAppointments.length > 0 ? (
                    ...
                    <tr key={app.id} className="border-bottom border-light">
                      ...
                      <td>
                        <span className="badge bg-light text-primary-navy border border-light-subtle px-3 py-2 fw-semibold d-inline-flex align-items-center">
                          ...
                          {formatTime12Hour(app.start_time)} -{" "}
                          {formatTime12Hour(app.end_time)}
                        </span>
                      </td>
                      ...
                      <td className="text-muted small">
                        {app.status === "Completed" &&
                          ...
                          <span className="text-primary fw-bold pulse">
                            Live Now
                          </span>
                        ) : (
            ...
            <div className="text-center py-5 bg-light rounded-4">
              ...
              <Link to="/user/book" className="btn btn-primary-navy px-4">
                Schedule Now
              </Link>
            </div>
          )}
